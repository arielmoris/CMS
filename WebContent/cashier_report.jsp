			...
			<div class="tabs_table">
		        <table summary="" cellpadding="0" cellspacing="0" border="0">
			       <tbody>
			       	<tr>
			            <td class="tabs0">&nbsp;&nbsp;</td>
			            <td class="tabs1">Cashier&nbsp;Report </td>
			            <td class="tabs4">&nbsp;</td>
			        </tr>
			        </tbody>
		        </table>
			...
			<div class="box_tabs" style="position: relative;">
				...
				<div class="row">
				 ...
				 <div class="row">
			        <div class="col-sm-6">
			            <div class="col-sm-4" style="padding-left:0px;">
			               <select name="summary_level" id="summary_level" class="field" style="width:220px;" onchange="check_select(this);"><option value="Account" title="">Account</option><option value="daily" title="">Daily</option><option value="detailed" title="">Detailed</option><option value="daterange" title="">Date Range Period</option></select>
			            </div>
			        </div>
			     </div>
			     <div class="row">
